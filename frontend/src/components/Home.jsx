    ...
    <>
      ...
      <div className="container page-wrap">
        <section className="home-hero">
          <h1 className="mb-2">Curated Picks For Everyday Shopping</h1>
          <p>Browse fast, compare smart, and check out in seconds with a cleaner experience across every device.</p>
        </section>
            ...
            filteredProducts.map((product) => {
              ...
              return (
                <div className="col" key={id}>
                  <div className={`card h-100 shadow-sm product-card ${!productAvailable ? 'bg-light' : ''}`}>
                    <Link to={`/product/${id}`} className="text-decoration-none text-dark">
                      ...
                      <div className="card-body d-flex flex-column">
                        ...
                        <p className="card-text product-meta fst-italic">~ {brand}</p>
                        <hr />
