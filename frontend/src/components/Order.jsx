...
const Order = () => {
  ...
  return (
    <div className="container page-wrap">
      <h2 className="page-title text-center">Order Management</h2>
      <p className="page-subtitle text-center">Track placed orders and inspect line-item details.</p>
      
      <div className="card shadow mb-4 section-card">
