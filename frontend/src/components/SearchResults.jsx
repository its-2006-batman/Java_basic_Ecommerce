...
const SearchResults = () => {
  ...
  if (loading) {
    return (
      <div className="container page-wrap d-flex justify-content-center align-items-center" style={{ minHeight: "50vh" }}>
  ...
  return (
    <div className="container page-wrap">
      ...
      <p className="page-subtitle">Browse matching products and add what you need quickly.</p>
