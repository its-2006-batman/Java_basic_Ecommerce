...
const handleLinkClick = () => {
  ...
  return (
    <nav className="navbar navbar-expand-lg fixed-top tshop-navbar" ref={navbarRef}>
      <div className="container-fluid">
        <Link className="navbar-brand" to="/" onClick={handleLinkClick}>Ecom</Link>
        <button
        ...
        >
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <NavLink className="nav-link" to="/add_product" onClick={handleLinkClick}>
                Add Product
              </NavLink>
            </li>

            <li className="nav-item">
              <NavLink className="nav-link" to="/orders" onClick={handleLinkClick}>
                Orders
              </NavLink>
            </li>
          ...
          <div className="d-flex align-items-center">
            <NavLink to="/cart" className="nav-link me-3" onClick={handleLinkClick}>
